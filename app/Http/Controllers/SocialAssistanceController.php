...
class SocialAssistanceController extends Controller implements HasMiddleware
{
    ...
    public function show(string $id)
    {
        try {
            ...
            return ResponseHelper::jsonResponse(false, 'Data Bantuan Sosial Berhasil Ditemukan', new SocialAssistanceResource($socialAssistance), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return ResponseHelper::jsonResponse(false, 'Data Bantuan Sosial Berhasil Dihapus', new SocialAssistanceResource($socialAssistance), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
